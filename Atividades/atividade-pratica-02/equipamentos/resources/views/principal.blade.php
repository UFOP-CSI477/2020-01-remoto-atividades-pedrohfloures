    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link btn btn-dark" href="{{ route('suporte') }}">Suporte</a></li>
                    ...
                    @guest
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link btn btn-dark" href="{{ route('user') }}">Usuários</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-dark" href="{{ route('equipamentos.index') }}">Equipamentos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-dark" href="{{ route('registros.index') }}">Registros</a>
                            </li>
